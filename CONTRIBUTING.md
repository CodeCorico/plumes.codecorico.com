# Contributing to the plumes.codecorico.com website and documentation
...
If you have questions about how to use Plumes or its website, please direct these to hello@codecorico.com.

## <a name="issue"></a> Found an Issue?
If you find a bug in the source code or a mistake in the wiki, you can help us by
submitting an issue to the [GitHub Repository](https://github.com/CodeCorico/plumes.codecorico.com/issues). Even better you can submit a Pull Request with a fix.

**Please see the Submission Guidelines below**.

## <a name="feature"></a> Want a Feature?
You can request a new feature by submitting an issue to the [GitHub Repository](https://github.com/CodeCorico/plumes.codecorico.com). If you
...
* **Small Changes** can be crafted and submitted to the [GitHub Repository](https://github.com/CodeCorico/plumes.codecorico.com) as a Pull Request.

A new issue create a discussion thread. Other contributors can advise and contribute to your ideas. Please search whether the subject does not already exists on the [opened issues](https://github.com/CodeCorico/plumes.codecorico.com/issues?q=is%3Aopen+is%3Aissue) before that to prevent duplicates issues.
...
* Search [GitHub pulls](https://github.com/CodeCorico/plumes.codecorico.com/pulls) for an open or closed Pull Request
...
* In GitHub, send a pull request to `plumes.codecorico.com:master`.
...
Only the lead contribution team can publish a new version. To do that, it requires that the milestone is completely finished ([Milestones](https://github.com/CodeCorico/plumes.codecorico.com/issues/milestones?state=open)).
...
* Push this branch to `plumes.codecorico.com:master`
